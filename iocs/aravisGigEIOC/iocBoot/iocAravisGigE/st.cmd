...
aravisCameraConfig("$(PORT)", "PointGrey-13481965")
dbLoadRecords("$(ARAVISGIGE)/db/PGR_Blackfly_20E4C.template","P=$(PREFIX),R=cam1:,PORT=$(PORT),ADDR=0,TIMEOUT=1")
...
#aravisCameraConfig("$(PORT)", "FLIR-18011754")
#dbLoadRecords("$(ARAVISGIGE)/db/FLIR_ORX_10G_51S5M.template","P=$(PREFIX),R=cam1:,PORT=$(PORT),ADDR=0,TIMEOUT=1")
