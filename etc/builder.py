...
class aravisCamera(_ADBase):
    ...
    ArgInfo = _ADBase.ArgInfo + _aravisCamera.ArgInfo + makeArgInfo(__init__,
        ...
        CLASS   = Choice('Camera class for custom commands', ["AVT_Manta", "AVT_Manta_1_44", "AVT_Manta_1_44_4", "Prosilica_GC", "Baumer_TXG", "JAI_6740", "PGR_Flea3", "Sony_CVC_EH6300", "Baumer_HXG20", "PSL_SCMOS"]),
