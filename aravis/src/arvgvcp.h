...
arv_gvcp_packet_get_read_memory_cmd_infos (const ArvGvcpPacket *packet, guint32 *address, guint32 *size)
{
	if (packet == NULL)
		return;
	if (address != NULL)
		*address = g_ntohl (*((guint32 *) ((void *) (((int) packet) + sizeof (ArvGvcpPacket)))));
	if (size != NULL)
		*size = (g_ntohl (*((guint32 *) ((void *) (((int) packet) + sizeof (ArvGvcpPacket) + sizeof (guint32)))))) &
			0xffff;
}
...
{
	return (void *) (((int) packet) + sizeof (ArvGvcpHeader) + sizeof (guint32));
}
...
{
	return (void *) (((int) packet) + sizeof (ArvGvcpPacket) + sizeof (guint32));
}
...
arv_gvcp_packet_get_read_register_ack_value (const ArvGvcpPacket *packet)
{
	if (packet == NULL)
		return 0;
	return g_ntohl (*((guint32 *) ((void *) (((int) packet) + sizeof (ArvGvcpPacket)))));
}
...
arv_gvcp_packet_get_write_register_cmd_infos (const ArvGvcpPacket *packet, guint32 *address, guint32 *value)
{
	...
	if (address != NULL)
		*address = g_ntohl (*((guint32 *) ((void *) (((int) packet) + sizeof (ArvGvcpPacket)))));
	if (value != NULL)
		*value = g_ntohl (*((guint32 *) ((void *) (((int) packet) + sizeof (ArvGvcpPacket) + sizeof (guint32)))));
}
